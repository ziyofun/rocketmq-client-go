...
//go:generate mockgen -source namesrv.go -destination mock_namesrv.go -self_package github.com/ziyofun/rocketmq-client-go/v2/internal  --package internal Namesrvs
